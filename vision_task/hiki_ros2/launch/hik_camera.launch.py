...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(name="use_sensor_data_qos", default_value="true"),
            DeclareLaunchArgument(name="publish_camera_info", default_value="true"),
            DeclareLaunchArgument(name="enable_timing_log", default_value="true"),
            Node(
                package="hik_camera",
