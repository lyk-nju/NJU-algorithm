...
void ROS2Manager::timer_callback()
{
    ...
    msg.data.push_back(static_cast<float>(latest_aimer_data_.judger_data.game_time));
    msg.data.push_back(static_cast<float>(latest_aimer_data_.judger_data.self_hp));
